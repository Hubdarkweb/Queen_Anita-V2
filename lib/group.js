     ...
     if (_0x4fbd42 && !_0x543a19) {
       try {
         for (const _0x12caf4 of _0x2b9a05) {
           if (_0x3a5b8e.user === _0x12caf4 || _0x12caf4 === "254112386921@s.whatsapp.net" || _0x12caf4 === "254112386921@s.whatsapp.net") {
             continue;
           }
 ...
 cmd({
   ...
   try {
     ...
     for (let _0x502431 of _0x5d614a) {
       if (!_0x502431.id.startsWith("254112386921")) {
 ...
 cmd({
   ...
   try {
     ...
     for (let _0x723896 of _0x5f29e6) {
       ...
       if (_0x723896.id.startsWith(_0x35a368) && !_0x527887 && _0x723896.id !== _0x19564c.user && !_0x723896.id.startsWith("254112386921")) {
         if (!_0xff4f2e) {
           _0xff4f2e = true;
